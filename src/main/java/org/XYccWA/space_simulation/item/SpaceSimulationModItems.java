...
import org.XYccWA.space_simulation.item.fuel.FuelBucketItem;
...
public class SpaceSimulationModItems {
    ...
    // 在SpaceSimulationModItems.java中修改SOURCE_HYDROGRN_PEROXIDE_BUCKET的注册
    public static final RegistryObject<BucketItem> SOURCE_HYDROGRN_PEROXIDE_BUCKET = ITEMS.register("source_hydrogrn_peroxide_bucket",
            () -> new FuelBucketItem(new Item.Properties().stacksTo(1)));
